package caitlinjee.creaturesoftheice;

import caitlinjee.creaturesoftheice.glk.GLKFrame;
import caitlinjee.creaturesoftheice.vm.VM;
import caitlinjee.creaturesoftheice.vm.VMThread;
...
{ 
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
		...
		vm=new VM("CreaturesOfTheIce",this,frame);
    }
...
//	}
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo)
    {
    	...
    	menu.setHeaderTitle("CreaturesOfTheIce");
